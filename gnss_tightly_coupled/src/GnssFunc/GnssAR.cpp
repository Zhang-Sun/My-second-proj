...
namespace IGCoupled {
    ...
    /*
    * Function : complementaty error function (from rtklib)
    */
    ...
    /*
    * Function : Confidence function of integer ambiguity
    */
    ...
    /*
    * Function : The constructor and destructor function of class cLambda(LAMBDA method)
    */
    cLambda::cLambda() {}
    ...
    /*
    * Function : LD factorization (Q = L' * diag(D) * L)
    * -Args :
    *        int      num_amb                   I           the number of ambiguity
    *        MatrixXd var_amb                   I           the variance of ambiguity
    *        VectorXd D                         O           
    *        MatrixXd L                         O           L and D after decomposition
    */
    ...
    */
    ...
    int cLambda::SearchFix(int num_amb,int num_fix_sols, VectorXd &sum_res,VectorXd &D,MatrixXd &L,VectorXd& z_float,MatrixXd& z_fix) {
        ...
        if(c>=LOOPMAX){
            CLOG(WARNING,ELPP_CURR_FILE_LOGGER_ID)<<"SEARCH LOOP COUNT OVERFLOW";
            return -1;
        }
        return 0;
    }
