// include IMU data decode struct / class / function 
// Created by wlzhang on 6/28/22.
//

#ifndef FAST_LIO_IGCOUPLED_DECODERAW_H
#define FAST_LIO_IGCOUPLED_DECODERAW_H
...
namespace IGCoupled {
    ...
    private:
        ...
        void GsofUnit2igcoupledsol(tGsofUnit& gsof,tSolInfoUnit& ppplib_sol);
...
#endif //FAST_LIO_IGCOUPLED_DECODERAW_H
